...
Monster getBasicMonster() {
    ...
    return {
            ...
            {{
             ...
             {
                     {NCOLOR_BLACK, NCOLOR_RED, NCOLOR_RED, NCOLOR_BLACK, NCOLOR_BLACK},
                     {NCOLOR_RED, NCOLOR_RED, NCOLOR_RED, NCOLOR_RED, NCOLOR_RED},
                     {NCOLOR_RED, NCOLOR_RED, NCOLOR_RED, NCOLOR_RED, NCOLOR_BLACK},
                     {NCOLOR_RED, NCOLOR_RED, NCOLOR_RED, NCOLOR_RED, NCOLOR_BLACK},
                     {NCOLOR_RED, NCOLOR_RED, NCOLOR_RED, NCOLOR_RED, NCOLOR_RED}
             }
            },
